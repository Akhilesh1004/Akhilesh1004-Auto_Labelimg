...
def detect(frame, net, transform):
    ...
    for i in range(detections.size(1)):
        ...
        while detections[0, i, j, 0] >= 0.6:
            ...
            j += 1
    pascal_ann = PascalVOC("/Users/ray/Desktop/test_annotation/cloud_annotation_test/1.jpg", size=size_block(500, 375, 3), objects=list)
    pascal_ann.save("/Users/ray/Desktop/test_annotation/1.xml")
    list = []
    return frame
...
while True:
    _, frame = video_capture.read('/Users/ray/Desktop/test_annotation/cloud_annotation_test/1.jpg')
